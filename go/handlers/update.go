...
import (
	...
	"github.com/intergreatme/remote-kyc-util/update"
)

// Endpoint to demonstrate update API
func (h *Handler) UpdateHandler(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := request.UpdateAPI(reqBody, h.Config)
	if err != nil {
	...
	log.Printf("\nUpdate API response: %s", payloadBody)
